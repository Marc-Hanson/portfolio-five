...
def page_leaves_visualizer_body():
    ...
    if st.checkbox("Difference between average and variability image."):
        ...
        st.warning(
            ...
            f"patterns that we could use to easily differentiate one from another. "
            f"However, mildew affected leaves tended to contain a greater concentration of white pixels in the center.")
    ...
    if st.checkbox("Differences between average infected and average healthy leaves."):
        ...
        st.warning(
            ...
            f"patterns where we could easily differentiate one from another.")
